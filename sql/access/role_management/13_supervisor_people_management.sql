...
values ('supervisor', 'can_manage_people')
...
begin
    ...
    into target_employee_id, previous_role, previous_active
    from public.users u
    ...
    if normalized_username = normalized_actor and (
        previous_role <> p_role or previous_active <> p_is_active
    ) then
    ...
    insert into public.app_user_access_audit (
        ...
        normalized_username, previous_role, p_role,
        previous_active, p_is_active,
