...
insert into uv_container_seed values
    (
        ...
        '9柜', '铁板画', '铁牌', '2030', 40000, '延迟', '400箱，100件/箱'
    ),
    (
        '9柜', date '2026-06-05', date '2026-07-20', null,
        '9柜', '铁板画', '铝牌', '2030', 20000, '延迟',
        '按数量20000件计；200件/箱折算100箱，原表箱数200不一致'
    ),
    (
        '9柜', date '2026-06-05', date '2026-07-20', null,
        '9柜', '铁板画', '铝牌', 'YUAN', 20100, '延迟', '67箱，300件/箱'
    ),
    (
        '9柜', date '2026-06-05', date '2026-07-20', null,
        '9柜', '铁板画', '铁牌', '3040', 25000, '延迟', '500箱，50件/箱'
    ),
    (
        '9柜', date '2026-06-05', date '2026-07-20', null,
        '9柜', '铁板画', '铁牌', '1040', 20000, '延迟', '200箱，100件/箱'
    ),
    (
        '11柜', date '2026-06-16', date '2026-07-31', null,
        '11柜', '铁板画', '铁牌', '2030', 85000, '未到货', '850箱，100件/箱'
    ),
    (
        '11柜', date '2026-06-16', date '2026-07-31', null,
        '11柜', '铁板画', '铁牌', 'YUAN', 15000, '未到货', '100箱，150件/箱'
    ),
    (
    ...
    (
        '12柜', date '2026-06-22', date '2026-08-06', null,
        '12柜', '铁板画', '铝牌', '2030', 30000, '未到货', '150箱，200件/箱'
    ),
    (
        '12柜', date '2026-06-22', date '2026-08-06', null,
        '12柜', '铁板画', '铝牌', 'YUAN', 30000, '未到货', '100箱，300件/箱'
    ),
    (
        '12柜', date '2026-06-22', date '2026-08-06', null,
        '12柜', '铁板画', '铁牌', '2030', 65000, '未到货', '650箱，100件/箱'
    );
